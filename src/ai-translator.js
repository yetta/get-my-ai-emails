...
3. **核心要点规则：原文中的每一条独立主题/新闻对应生成一个核心要点。不要将一条主题的多个细节拆分成多个独立要点。**
   - 每个核心要点内部可以包含多个详细信息（如功能特性、技术细节等），但这些信息应该作为该要点的子内容，而不是独立的要点
...
[继续列出原文中的每一条独立主题，每条主题对应一个核心要点。如果原文有配图就保留对应的占位符]
